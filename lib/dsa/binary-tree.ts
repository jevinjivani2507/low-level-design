  ...
  questions: [
    {
      ...
      testCases: [
        ...
        },
        {
          ...
          explanation: "",
          diagrams: [[1, 2, 3, 4, 5, null, 8, null, null, 6, 7, 9]],
        },
      ],
      type: "TREE",
      code: `class Solution {
      ...
      testCases: [
        {
          ...
          output: "[[3],[9,20],[15,7]]",
          explanation: "",
          diagrams: [[3, 9, 20, null, null, 15, 7]],
        },
        {
          input: "root = [1]",
          output: "[[1]]",
    ...
    },
    {
      ...
      testCases: [
        ...
        },
        {
          ...
          output: "false",
          explanation: "",
          diagrams: [[1, 2, 2, 3, 3, null, null, 4, 4]],
        },
        {
          input: "root = []",
          output: "true",
    ...
    },
    {
      ...
      testCases: [
        ...
        },
        {
          ...
          output: "42",
          explanation: "",
          diagrams: [[-10, 9, 20, null, null, 15, 7]],
        },
      ],
      code: `class Solution {
public:
      ...
      testCases: [
        {
          ...
          output: "[1,3,4]",
          explanation: "",
          diagrams: [[1, 2, 3, null, 5, null, 4]],
        },
        {
          input: "root = [1,2,3,4,null,null,null,5]",
          output: "[1,2,4,5]",
          explanation: "",
          diagrams: [[1, 2, 3, 4, null, null, null, 5]],
        },
        {
          input: "root = []",
          output: "[]",
      ...
      testCases: [
        {
          ...
          output: "3",
          explanation: "",
          diagrams: [[3, 5, 1, 6, 2, 0, 8, null, null, 7, 4]],
        },
        {
      ...
      testCases: [
        {
          ...
          output: "4",
          explanation: "",
          diagrams: [[1, 3, 2, 5, 3, null, 9]],
        },
        {
          input: "root = [1,3,2,5,null,null,9,6,null,7]",
          output: "7",
          explanation: "",
          diagrams: [[1, 3, 2, 5, null, null, 9, 6, null, 7]],
        },
        {
          input: "root = [1,3,2,5]",
          output: "7",
